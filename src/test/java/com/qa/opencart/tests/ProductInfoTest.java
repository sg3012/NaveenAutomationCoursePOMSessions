...
public class ProductInfoTest extends BaseTest {
	...
	public void prodInfoSetup() {
		accountsPage = loginPage.doLogin(prop.getProperty("username"), 
				prop.getProperty("password")); // login to app
	...
	// 1.Dataprovider supplying the data
	...
	// 2. Dataprovider supplying the data
...
//	}
	...
	public void productInfoTest() {
		...
		// Now asserting respective values against each key
